...
# Identify the highest-priced wine
highest_price_row <- which.max(df$price)
highest_price_wine <- df[highest_price_row, ]

# Identify the wine with the highest score
highest_score_row <- which.max(df$points)
highest_score_wine <- df[highest_score_row, ]

# Compare characteristics of the highest-priced wine and the one with the highest score
print("Characteristics of the Highest-Priced Wine:")
print(highest_price_wine)

print("Characteristics of the Wine with the Highest Score:")
print(highest_score_wine)
...
taster1 <- head(df %>% count(taster_name) %>% arrange(desc(n)), 20)
...
g <- ggplot(data = subset(df, taster_name %in% taster20), aes(x = taster_name, 
  ...
  theme(legend.position = "none") + 
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  ggtitle("taster_name Of Wine Origin Count") +
  xlab("taster_name's") +
  ylab("Count")
...
g <-ggplot(data = subset(df %>% drop_na(taster_name), taster_name %in% taster20), 
  ...
  geom_boxplot() +
  ggtitle("Price by taster_name Of Wine Origin") +
  xlab("taster_name's") +
  ylab("Price") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  theme(legend.position = "none") 
...
province1 <- head(df %>% count(province) %>% arrange(desc(n)), 20)
...
g <- ggplot(data = subset(df, variety %in% variety20), aes(x = variety, 
  ...
  theme(legend.position = "none") + 
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  ggtitle("variety Of Wine Origin Count") +
  xlab("variety's") +
  ylab("Count")
...
g <-ggplot(data = subset(df %>% drop_na(variety), variety %in% variety20), 
  ...
  geom_boxplot() +
  ggtitle("Price by variety Of Wine Origin") +
  xlab("variety's") +
  ylab("Price") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  theme(legend.position = "none") 
...
g <- ggplot(data = subset(df, winery %in% winery20), aes(x = winery, 
  ...
  theme(legend.position = "none") + 
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  ggtitle("winery Of Wine Origin Count") +
  xlab("winery's") +
  ylab("Count")
...
g <-ggplot(data = subset(df %>% drop_na(winery), winery %in% winery20), 
  ...
  geom_boxplot() +
  ggtitle("Price by winery Of Wine Origin") +
  xlab("winery's") +
  ylab("Price") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  theme(legend.position = "none")
